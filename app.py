...
def index():
    ...
    total_initiatives = total_initiatives_result['count'] if total_initiatives_result else 0
...
def load_more_initiatives():
    ...
    return jsonify({
        'initiatives': [{
            ...
            'date_created': initiative['date_created'],
            'likes': initiative_likes[initiative['id']],
            'dislikes': initiative_dislikes[initiative['id']]
        } for initiative in initiatives],
